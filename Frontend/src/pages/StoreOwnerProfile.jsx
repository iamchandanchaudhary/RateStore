...
const StoreOwnerProfile = () => {
    ...
    useEffect(() => {
        ...
        const loadProfile = async () => {
            ...
            try {
                const response = await fetch(`${baseUrl}/api/store-owners/${user.id}`);
        ...
        try {
            ...
            if (data.user) {
                ...
                login({
                    ...user,
                    ...data.user,
                    role: data.user.role || user.role || "store-owner"
                });
            }
    ...
    const handlePasswordSubmit = async () => {
        ...
        try {
            const response = await fetch(`${baseUrl}/api/store-owners/${user.id}/password`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
                    ...
                    {isLoading ? (
                        ...
                        <div className="space-y-6">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                >
                                    {(formValues.name || user?.name || "O").charAt(0)}
                                </span>
